        ...
        return (
            <div className={classes.spbg + " container align-items-center mt-5"}>
                <div className="row justify-content-center">
                    <p className={classes.headtext + " text-white font-weight-bold my-3"}>Your Perfect</p>
                </div>
                <div className="row justify-content-center">
                    <p className={classes.headtext2 + " text-white font-weight-bold mb-2"}>Banking Partner</p>
                </div>
                <div className="row justify-content-center">
